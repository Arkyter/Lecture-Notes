...
\end{definition}
Note that if $E/F$ is finite, then $E/F$ is algebraic, e.g., $\mathbb{A}/\QQ$ is an algebraic extension but is not finite. $\QQ[\!\sqrt[n]{2}]$ for all $n \geq 1$ over $\QQ$ is not finite.
\begin{theorem}
