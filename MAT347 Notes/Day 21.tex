...
\begin{definition}
    An \textit{ideal} $I$ in a ring $R$ is a subset $I \subset R$ such that $I$ is a subring and, for all $a \in R$, we have $aI \subset I$ and $Ia \subset I$, which is equivalent to $RI = I = IR$.
\end{definition}
