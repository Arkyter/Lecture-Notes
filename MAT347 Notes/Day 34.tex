...
\end{proof}
If we denote $A(\bullet)$ as the algebraic extension, then observe that $Q \subset A(\QQ) \subset A(A(\QQ)) \subset \dots$, where $\QQ \subset \CC$ and $A(\QQ) \subset \mathbb{A}$.
\begin{theorem}
...
% \end{definition}
\begin{corollary}
    $\QQ \subsetneq \mathbb{A} \subsetneq \CC$; here, $\mathbb{A}$ is algebraically closed, meaning, every polynomial with coefficients in $\mathbb{A}$ has roots in $\mathbb{A}$. Note that $\mathbb{A}$ is countable but $\CC$ is not.
\end{corollary}
\begin{proof}
