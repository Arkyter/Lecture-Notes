\section{Day 30: Tensors as a Ring (Jan.\ 23, 2026)}
...
\[ \begin{tikzcd}[column sep=2cm] R \times M \arrow[r, "\ell\colon (r{,}m) \mapsto rm"] \arrow[rd, "f"] & R \otimes M \arrow[d, "\wt f(m)=(1{,}m)"] \\ & N \end{tikzcd} \]
...
\[ \begin{tikzcd} A \otimes (B \oplus C) \arrow[r] \arrow[rd] & A \otimes (B \oplus C) \arrow[d, dashed, "f"] \\ & (A \otimes B) \oplus (A \otimes C) \end{tikzcd} \]
