...
\end{proof}
\begin{proposition}
    If $A' = PAQ$, where $P \in M_{G \times G}(\ZZ)$ is invertible, $Q \in M_{X \times X}(\ZZ)$ is invertible (whose columns have finite support and finite inverses), then $M_A = M_{A'}$, i.e.,
