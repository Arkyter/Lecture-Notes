...
\end{proof}
\noindent Take $J \supset I_\infty$; there are $2^{2^\omega}$ because $\abs{\beta \NN} = 2^{2^{\omega}}$ (the ultrafilter on the set of naturals coincides with the Stone--\v{C}ech compactification of $\NN$). We claim that $\ell^\infty / J \cong R$.
\begin{proof}
