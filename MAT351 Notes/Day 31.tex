\section{Day 31: Green's Stuff (Feb. 9, 2026)}
...
I couldn't really focus today because 425 was on my mind. Please consult Strauss for this content if they are unclear. But most of the class was spent on a question which we had already answered.
...
\begin{proof}
	...
	This gives us our Green's function. Well not really. It doesn't vanish along the boundary. So we need to add a new term to the denominator to make it satisfy the properties we want. We will cover this next time.
\end{proof}
