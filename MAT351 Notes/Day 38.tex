...
where $k = \frac{\pi}{2\ell}$ yields $\frac{dM}{2\ell} = dk$.\footnote{This is somewhat informal} The above computation leads us to define
...
We now make some definitions. An \textit{integrable} function $f \colon \RR^d \to \CC$ is a function that satisfies $\norm{f}_1 < \infty$, i.e.,
