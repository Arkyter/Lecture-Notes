...
\end{proof}
\begin{theorem}
    A constant real-valued function $u(z)$ in a region $\Omega \subset \CC$ which satisfies the mean value property is harmonic.
\end{theorem}
